...
var YAxis = function (_React$Component) {
    ...
    _createClass(YAxis, [{
        ...
        value: function componentWillReceiveProps(nextProps) {
            ...
            } else if (this.props.format !== format || this.props.align !== align || this.props.width !== width || this.props.height !== height || this.props.type !== type || this.props.absolute !== absolute || this.props.chartExtent !== chartExtent || this.props.showGrid !== showGrid || this.props.hideAxisLine !== hideAxisLine || this.props.label !== label) {
