...
var LabelAxis = function (_React$Component) {
    ...
    _createClass(LabelAxis, [{
        ...
        value: function render() {
            ...
            var userLabelYPos = this.props.labelYPos;
            ...
            if (this.props.values) {
                labelYPos = userLabelYPos != null ? userLabelYPos : this.propMath.max(parseInt(this.props.height / 4, 10), 10);
...
LabelAxis.propTypes = {
     ...
     */
    labelYPos: _propTypes2.default.number,
