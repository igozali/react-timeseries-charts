    ...
    _createClass(EventHandler, [
        ...
        },
        {
            ...
            value: function handleScrollWheel(e) {
                ...
                var deltaY = e.deltaMode === WheelEvent.DOM_DELTA_PIXEL ? e.deltaY : e.deltaY * 16;

                var SCALE_FACTOR = 0.001;
                var scale = 1 + deltaY * SCALE_FACTOR;
                if (scale > 3) {
                    scale = 3;
                }
                if (scale < 0.1) {
